...
import { MemberAccountReportsOverview } from "@/components/dashboard/member-account-reports-views";

export default async function MemberAccountReportsPage({
  searchParams,
}: {
  ...
  return <MemberAccountReportsOverview report={report} />;
}
