...
import { MemberLoginsReportView } from "@/components/dashboard/member-account-reports-views";

export default async function MemberLoginsReportsPage({
  searchParams,
}: {
  ...
  return <MemberLoginsReportView report={report} />;
}
