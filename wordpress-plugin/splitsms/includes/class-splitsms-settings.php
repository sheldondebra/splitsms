...
class SplitSMS_Settings {
    ...
    public static function defaults() {
        ...
        return array(
            ...
            'wc_tpl_failed' => 'Hi {customer_name}, payment for order #{order_id} could not be completed. Please try again or contact {site_name}.',
            'wc_tpl_refunded' => 'Hi {customer_name}, a refund of {refund_amount} was issued for order #{order_id} at {site_name}.',
            'wc_tpl_shipped' => 'Hi {customer_name}, order #{order_id} has shipped. Tracking: {tracking_number}. — {site_name}',
